            ...
            <div className="flex items-center gap-2">
              <Link href="/organization/schools">
                <Button variant="outline" size="sm" className="text-xs gap-1 border-slate-300 dark:border-slate-700">
                  <Building2 className="w-3.5 h-3.5 text-blue-500" /> Manage Fleet &amp; Status
                </Button>
              </Link>
              <Link href="/organization/add-school">
                <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white text-xs gap-1 shadow-xs font-medium">
